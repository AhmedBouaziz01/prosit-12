...
public class Main {
    public static void main(String[] args) {
        ...
        Etudiant student1 = new Etudiant(1, "Ahmed", 22);
        Etudiant student2 = new Etudiant(2, "Bouaziz", 22);
        Etudiant student3 = new Etudiant(3, "Selim", 21);
        ...
        Supplier<Etudiant> createNewStudent = () -> new Etudiant(4, "Rayen", 23);
